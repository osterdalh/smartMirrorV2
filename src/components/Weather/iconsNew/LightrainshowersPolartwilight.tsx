...
const SvgLightrainshowersPolartwilight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="lightrainshowers_polartwilight_svg__d">
      <path
        fill="#0062bf"
        d="M2.5 13A2.5 2.5 0 0 1 .21 9.51l3.55-8a2.5 2.5 0 0 1 4.57 2l-3.55 8A2.5 2.5 0 0 1 2.5 13Z"
      />
    </symbol>
    <symbol id="lightrainshowers_polartwilight_svg__c">
    ...
    <symbol id="lightrainshowers_polartwilight_svg__f">
      <path
        fill="url(#lightrainshowers_polartwilight_svg__a)"
        ...
        className="lightrainshowers_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="lightrainshowers_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#lightrainshowers_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="lightrainshowers_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="lightrainshowers_polartwilight_svg__i">
      <use
        xlinkHref="#lightrainshowers_polartwilight_svg__c"
        width={100}
        height={100}
        fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightrainshowers_polartwilight_svg__d"
        width={100}
        height={100}
    ...
    <symbol id="lightrainshowers_polartwilight_svg__h">
      <g mask="url(#lightrainshowers_polartwilight_svg__e)">
        <use
          xlinkHref="#lightrainshowers_polartwilight_svg__f"
          width={100}
          height={100}
          className="lightrainshowers_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="lightrainshowers_polartwilight_svg__g">
      ...
      <mask id="lightrainshowers_polartwilight_svg__e">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <radialGradient
        id="lightrainshowers_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="lightrainshowers_polartwilight_svg__b"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="lightrainshowers_polartwilight_svg__j">
      <g mask="url(#lightrainshowers_polartwilight_svg__g)">
        <use
          xlinkHref="#lightrainshowers_polartwilight_svg__h"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#lightrainshowers_polartwilight_svg__i"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#lightrainshowers_polartwilight_svg__j"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgLightrainshowersPolartwilight;
