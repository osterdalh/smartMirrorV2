...
const SvgHeavyrainshowersandthunderPolartwilight = (
  ...
  <svg
    ...
    {...props}
  >
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__f">
      <path
        fill="#0062bf"
        d="M2.5 13A2.5 2.5 0 0 1 .21 9.51l3.55-8a2.5 2.5 0 0 1 4.57 2l-3.55 8A2.5 2.5 0 0 1 2.5 13Z"
      />
    </symbol>
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__e">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__d">
    ...
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__h">
      <path
        fill="url(#heavyrainshowersandthunder_polartwilight_svg__a)"
        ...
        className="heavyrainshowersandthunder_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="heavyrainshowersandthunder_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#heavyrainshowersandthunder_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="heavyrainshowersandthunder_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__k">
      <g mask="url(#heavyrainshowersandthunder_polartwilight_svg__c)">
        <use
          xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__d"
          width={100}
          height={100}
          fill="#999"
      ...
      <use
        xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__e"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__f"
        width={100}
        height={100}
    ...
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__j">
      <g mask="url(#heavyrainshowersandthunder_polartwilight_svg__g)">
        <use
          xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__h"
          width={100}
          height={100}
          className="heavyrainshowersandthunder_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="heavyrainshowersandthunder_polartwilight_svg__i">
      ...
      <mask id="heavyrainshowersandthunder_polartwilight_svg__g">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <mask id="heavyrainshowersandthunder_polartwilight_svg__c">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__e"
          width={100}
      ...
      <radialGradient
        id="heavyrainshowersandthunder_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="heavyrainshowersandthunder_polartwilight_svg__b"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="heavyrainshowersandthunder_polartwilight_svg__l">
      <g mask="url(#heavyrainshowersandthunder_polartwilight_svg__i)">
        <use
          xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__j"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__k"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#heavyrainshowersandthunder_polartwilight_svg__l"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgHeavyrainshowersandthunderPolartwilight;
