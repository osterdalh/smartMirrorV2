...
const SvgHeavysleetshowersandthunderDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="heavysleetshowersandthunder_day_svg__e">
      <path
        fill="#0062bf"
        d="M2.5 13A2.5 2.5 0 0 1 .21 9.51l3.55-8a2.5 2.5 0 0 1 4.57 2l-3.55 8A2.5 2.5 0 0 1 2.5 13Z"
      />
    </symbol>
    <symbol id="heavysleetshowersandthunder_day_svg__d">
      <path
        fill="#47c0e3"
    ...
    <symbol id="heavysleetshowersandthunder_day_svg__c">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="heavysleetshowersandthunder_day_svg__b">
    ...
    <symbol id="heavysleetshowersandthunder_day_svg__j">
      <g mask="url(#heavysleetshowersandthunder_day_svg__a)">
        <use
          xlinkHref="#heavysleetshowersandthunder_day_svg__b"
          width={100}
          height={100}
          fill="#999"
      ...
      <use
        xlinkHref="#heavysleetshowersandthunder_day_svg__c"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#heavysleetshowersandthunder_day_svg__d"
        width={100}
        height={100}
        transform="translate(15 79)"
      />
      <use
        xlinkHref="#heavysleetshowersandthunder_day_svg__e"
        width={100}
        height={100}
    ...
    <symbol id="heavysleetshowersandthunder_day_svg__i">
      <path
        fill="url(#heavysleetshowersandthunder_day_svg__f)"
        ...
        className="heavysleetshowersandthunder_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="heavysleetshowersandthunder_day_svg__sun-outer"
      />
      <path
        fill="url(#heavysleetshowersandthunder_day_svg__g)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="heavysleetshowersandthunder_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <mask id="heavysleetshowersandthunder_day_svg__h">
      ...
      <mask id="heavysleetshowersandthunder_day_svg__a">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#heavysleetshowersandthunder_day_svg__c"
          width={100}
      ...
      <radialGradient
        id="heavysleetshowersandthunder_day_svg__f"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="heavysleetshowersandthunder_day_svg__g"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="heavysleetshowersandthunder_day_svg__k">
      <g mask="url(#heavysleetshowersandthunder_day_svg__h)">
        <use
          xlinkHref="#heavysleetshowersandthunder_day_svg__i"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavysleetshowersandthunder_day_svg__j"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#heavysleetshowersandthunder_day_svg__k"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgHeavysleetshowersandthunderDay;
