...
const SvgHeavyrainshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="heavyrainshowers_night_svg__f">
      <use
        xlinkHref="#heavyrainshowers_night_svg__a"
        width={100}
        height={100}
        fill="#999"
      ...
      />
      <use
        xlinkHref="#heavyrainshowers_night_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="heavyrainshowers_night_svg__e">
      <path
        fill="url(#heavyrainshowers_night_svg__c)"
    ...
    <defs>
      <linearGradient
        id="heavyrainshowers_night_svg__c"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
      ...
      <mask id="heavyrainshowers_night_svg__d">
    ...
    <symbol id="heavyrainshowers_night_svg__g">
      <g mask="url(#heavyrainshowers_night_svg__d)">
        <use
          xlinkHref="#heavyrainshowers_night_svg__e"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavyrainshowers_night_svg__f"
        width={100}
        height={100}
      />
    </symbol>
    <use xlinkHref="#heavyrainshowers_night_svg__g" width={100} height={100} />
  </svg>
);
export default SvgHeavyrainshowersNight;
