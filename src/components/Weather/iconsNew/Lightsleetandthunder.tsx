...
const SvgLightsleetandthunder = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightsleetandthunder_svg__a">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="lightsleetandthunder_svg__c">
    ...
    <defs>
      <mask id="lightsleetandthunder_svg__b">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#lightsleetandthunder_svg__a"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="lightsleetandthunder_svg__f">
      <g mask="url(#lightsleetandthunder_svg__b)">
        <use
          xlinkHref="#lightsleetandthunder_svg__c"
          width={100}
          height={100}
          fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightsleetandthunder_svg__d"
        width={100}
        height={100}
        transform="translate(26 88)"
      />
      <use
        xlinkHref="#lightsleetandthunder_svg__e"
        width={100}
        height={100}
        transform="translate(58 79)"
      />
    </symbol>
    <use xlinkHref="#lightsleetandthunder_svg__f" width={100} height={100} />
  </svg>
);
export default SvgLightsleetandthunder;
