...
const SvgLightsnowandthunder = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="lightsnowandthunder_svg__d">
      <path
        fill="#47c0e3"
    ...
    <symbol id="lightsnowandthunder_svg__a">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="lightsnowandthunder_svg__c">
    ...
    <defs>
      <mask id="lightsnowandthunder_svg__b">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#lightsnowandthunder_svg__a"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="lightsnowandthunder_svg__e">
      <g mask="url(#lightsnowandthunder_svg__b)">
        <use
          xlinkHref="#lightsnowandthunder_svg__c"
          width={100}
          height={100}
          fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightsnowandthunder_svg__d"
        width={100}
        height={100}
    ...
    <use xlinkHref="#lightsnowandthunder_svg__e" width={100} height={100} />
  </svg>
);
export default SvgLightsnowandthunder;
