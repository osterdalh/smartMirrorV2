...
const SvgSleetandthunder = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <mask id="sleetandthunder_svg__b">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#sleetandthunder_svg__a"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="sleetandthunder_svg__f">
      <g mask="url(#sleetandthunder_svg__b)">
        <use
          xlinkHref="#sleetandthunder_svg__c"
          width={100}
          height={100}
          fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#sleetandthunder_svg__d"
        width={100}
        height={100}
        transform="translate(27 79)"
      />
      <use
        xlinkHref="#sleetandthunder_svg__e"
        width={100}
        height={100}
    ...
    <use xlinkHref="#sleetandthunder_svg__f" width={100} height={100} />
  </svg>
);
export default SvgSleetandthunder;
