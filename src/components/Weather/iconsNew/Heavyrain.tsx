...
const SvgHeavyrain = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <symbol id="heavyrain_svg__c">
      <use
        xlinkHref="#heavyrain_svg__a"
        width={100}
        height={100}
        fill="#999"
    ...
    <use xlinkHref="#heavyrain_svg__c" width={100} height={100} />
  </svg>
);
