...
const SvgFairDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="fair_day_svg__e">
      <path
        fill="url(#fair_day_svg__a)"
        ...
        className="fair_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="fair_day_svg__sun-outer"
      />
      <path
        fill="url(#fair_day_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="fair_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
      ...
      <linearGradient id="fair_day_svg__b" x1="0%" x2="100%" y1="0%" y2="100%">
        <stop offset="0%" stopColor="#ffaf22" />
        <stop offset="100%" stopColor="#f09900" />
      </linearGradient>
      <mask id="fair_day_svg__d">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#fair_day_svg__c"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="fair_day_svg__f">
      <g mask="url(#fair_day_svg__d)">
        <use
          xlinkHref="#fair_day_svg__e"
          width={100}
          height={100}
    ...
    <use xlinkHref="#fair_day_svg__f" width={100} height={100} />
  </svg>
);
export default SvgFairDay;
