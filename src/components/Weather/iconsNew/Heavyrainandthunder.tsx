...
const SvgHeavyrainandthunder = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <defs>
      <mask id="heavyrainandthunder_svg__b">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#heavyrainandthunder_svg__a"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="heavyrainandthunder_svg__e">
      <g mask="url(#heavyrainandthunder_svg__b)">
        <use
          xlinkHref="#heavyrainandthunder_svg__c"
          width={100}
          height={100}
          fill="#999"
      ...
      />
      <use
        xlinkHref="#heavyrainandthunder_svg__d"
        width={100}
        height={100}
    ...
    <use xlinkHref="#heavyrainandthunder_svg__e" width={100} height={100} />
  </svg>
);
export default SvgHeavyrainandthunder;
