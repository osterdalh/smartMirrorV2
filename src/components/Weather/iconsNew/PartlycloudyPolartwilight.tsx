...
const SvgPartlycloudyPolartwilight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="partlycloudy_polartwilight_svg__c">
    ...
    <symbol id="partlycloudy_polartwilight_svg__e">
      <path
        fill="url(#partlycloudy_polartwilight_svg__a)"
        ...
        className="partlycloudy_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="partlycloudy_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#partlycloudy_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="partlycloudy_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="partlycloudy_polartwilight_svg__h">
      <use
        xlinkHref="#partlycloudy_polartwilight_svg__c"
        width={100}
        height={100}
        fill="#ddd"
    ...
    <symbol id="partlycloudy_polartwilight_svg__g">
      <g mask="url(#partlycloudy_polartwilight_svg__d)">
        <use
          xlinkHref="#partlycloudy_polartwilight_svg__e"
          width={100}
          height={100}
          className="partlycloudy_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="partlycloudy_polartwilight_svg__f">
      ...
      <mask id="partlycloudy_polartwilight_svg__d">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <radialGradient
        id="partlycloudy_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="partlycloudy_polartwilight_svg__b"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="partlycloudy_polartwilight_svg__i">
      <g mask="url(#partlycloudy_polartwilight_svg__f)">
        <use
          xlinkHref="#partlycloudy_polartwilight_svg__g"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#partlycloudy_polartwilight_svg__h"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#partlycloudy_polartwilight_svg__i"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgPartlycloudyPolartwilight;
