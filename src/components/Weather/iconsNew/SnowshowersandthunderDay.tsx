...
const SvgSnowshowersandthunderDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="snowshowersandthunder_day_svg__d">
      <path
        fill="#47c0e3"
    ...
    <symbol id="snowshowersandthunder_day_svg__c">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="snowshowersandthunder_day_svg__b">
    ...
    <symbol id="snowshowersandthunder_day_svg__i">
      <g mask="url(#snowshowersandthunder_day_svg__a)">
        <use
          xlinkHref="#snowshowersandthunder_day_svg__b"
          width={100}
          height={100}
          fill="#b2b2b2"
      ...
      <use
        xlinkHref="#snowshowersandthunder_day_svg__c"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#snowshowersandthunder_day_svg__d"
        width={100}
        height={100}
    ...
    <symbol id="snowshowersandthunder_day_svg__h">
      <path
        fill="url(#snowshowersandthunder_day_svg__e)"
        ...
        className="snowshowersandthunder_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="snowshowersandthunder_day_svg__sun-outer"
      />
      <path
        fill="url(#snowshowersandthunder_day_svg__f)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="snowshowersandthunder_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <mask id="snowshowersandthunder_day_svg__g">
      ...
      <mask id="snowshowersandthunder_day_svg__a">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#snowshowersandthunder_day_svg__c"
          width={100}
      ...
      <radialGradient
        id="snowshowersandthunder_day_svg__e"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="snowshowersandthunder_day_svg__f"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="snowshowersandthunder_day_svg__j">
      <g mask="url(#snowshowersandthunder_day_svg__g)">
        <use
          xlinkHref="#snowshowersandthunder_day_svg__h"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#snowshowersandthunder_day_svg__i"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#snowshowersandthunder_day_svg__j"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgSnowshowersandthunderDay;
