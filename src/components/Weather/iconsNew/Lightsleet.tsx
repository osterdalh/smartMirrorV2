...
const SvgLightsleet = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightsleet_svg__d">
      <use
        xlinkHref="#lightsleet_svg__a"
        width={100}
        height={100}
        fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightsleet_svg__b"
        width={100}
        height={100}
        transform="translate(29 88)"
      />
      <use
        xlinkHref="#lightsleet_svg__c"
        width={100}
        height={100}
        transform="translate(60 79)"
      />
    </symbol>
    <use xlinkHref="#lightsleet_svg__d" width={100} height={100} />
  </svg>
);
