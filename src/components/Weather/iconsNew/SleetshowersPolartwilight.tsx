...
const SvgSleetshowersPolartwilight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="sleetshowers_polartwilight_svg__c">
    ...
    <symbol id="sleetshowers_polartwilight_svg__g">
      <path
        fill="url(#sleetshowers_polartwilight_svg__a)"
        ...
        className="sleetshowers_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="sleetshowers_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#sleetshowers_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="sleetshowers_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="sleetshowers_polartwilight_svg__j">
      <use
        xlinkHref="#sleetshowers_polartwilight_svg__c"
        width={100}
        height={100}
        fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#sleetshowers_polartwilight_svg__d"
        width={100}
        height={100}
        transform="translate(30 79)"
      />
      <use
        xlinkHref="#sleetshowers_polartwilight_svg__e"
        width={100}
        height={100}
    ...
    <symbol id="sleetshowers_polartwilight_svg__i">
      <g mask="url(#sleetshowers_polartwilight_svg__f)">
        <use
          xlinkHref="#sleetshowers_polartwilight_svg__g"
          width={100}
          height={100}
          className="sleetshowers_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="sleetshowers_polartwilight_svg__h">
      ...
      <mask id="sleetshowers_polartwilight_svg__f">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <radialGradient
        id="sleetshowers_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="sleetshowers_polartwilight_svg__b"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="sleetshowers_polartwilight_svg__k">
      <g mask="url(#sleetshowers_polartwilight_svg__h)">
        <use
          xlinkHref="#sleetshowers_polartwilight_svg__i"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#sleetshowers_polartwilight_svg__j"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#sleetshowers_polartwilight_svg__k"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgSleetshowersPolartwilight;
