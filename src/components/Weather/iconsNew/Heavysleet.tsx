...
const SvgHeavysleet = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="heavysleet_svg__d">
      ...
      />
      <use
        xlinkHref="#heavysleet_svg__b"
        width={100}
        height={100}
        transform="translate(15 79)"
      />
      <use
        xlinkHref="#heavysleet_svg__c"
        width={100}
        height={100}
    ...
    <use xlinkHref="#heavysleet_svg__d" width={100} height={100} />
  </svg>
);
