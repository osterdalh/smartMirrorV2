...
const SvgSnowshowersandthunderNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="snowshowersandthunder_night_svg__d">
      <path
        fill="#47c0e3"
    ...
    <symbol id="snowshowersandthunder_night_svg__c">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="snowshowersandthunder_night_svg__b">
    ...
    <symbol id="snowshowersandthunder_night_svg__h">
      <g mask="url(#snowshowersandthunder_night_svg__a)">
        <use
          xlinkHref="#snowshowersandthunder_night_svg__b"
          width={100}
          height={100}
          fill="#b2b2b2"
      ...
      <use
        xlinkHref="#snowshowersandthunder_night_svg__c"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#snowshowersandthunder_night_svg__d"
        width={100}
        height={100}
    ...
    <symbol id="snowshowersandthunder_night_svg__g">
      <path
        fill="url(#snowshowersandthunder_night_svg__e)"
    ...
    <defs>
      <mask id="snowshowersandthunder_night_svg__f">
      ...
      <mask id="snowshowersandthunder_night_svg__a">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#snowshowersandthunder_night_svg__c"
          width={100}
      ...
      <linearGradient
        id="snowshowersandthunder_night_svg__e"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
    ...
    <symbol id="snowshowersandthunder_night_svg__i">
      <g mask="url(#snowshowersandthunder_night_svg__f)">
        <use
          xlinkHref="#snowshowersandthunder_night_svg__g"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#snowshowersandthunder_night_svg__h"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#snowshowersandthunder_night_svg__i"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgSnowshowersandthunderNight;
