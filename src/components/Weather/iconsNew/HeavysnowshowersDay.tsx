...
const SvgHeavysnowshowersDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="heavysnowshowers_day_svg__b">
      <path
        fill="#47c0e3"
    ...
    <symbol id="heavysnowshowers_day_svg__a">
    ...
    <symbol id="heavysnowshowers_day_svg__g">
      <use
        xlinkHref="#heavysnowshowers_day_svg__a"
        width={100}
        height={100}
        fill="#999"
      ...
      />
      <use
        xlinkHref="#heavysnowshowers_day_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="heavysnowshowers_day_svg__f">
      <path
        fill="url(#heavysnowshowers_day_svg__c)"
        ...
        className="heavysnowshowers_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="heavysnowshowers_day_svg__sun-outer"
      />
      <path
        fill="url(#heavysnowshowers_day_svg__d)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="heavysnowshowers_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
        id="heavysnowshowers_day_svg__c"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="heavysnowshowers_day_svg__d"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
      ...
      <mask id="heavysnowshowers_day_svg__e">
    ...
    <symbol id="heavysnowshowers_day_svg__h">
      <g mask="url(#heavysnowshowers_day_svg__e)">
        <use
          xlinkHref="#heavysnowshowers_day_svg__f"
          width={100}
          height={100}
          transform="matrix(.7 0 0 .7 0 2)"
        />
      </g>
      <use xlinkHref="#heavysnowshowers_day_svg__g" width={100} height={100} />
    </symbol>
    <use xlinkHref="#heavysnowshowers_day_svg__h" width={100} height={100} />
  </svg>
);
export default SvgHeavysnowshowersDay;
