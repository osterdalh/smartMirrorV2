...
const SvgSnowandthunder = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="snowandthunder_svg__d">
      <path
        fill="#47c0e3"
    ...
    <defs>
      <mask id="snowandthunder_svg__b">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#snowandthunder_svg__a"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="snowandthunder_svg__e">
      <g mask="url(#snowandthunder_svg__b)">
        <use
          xlinkHref="#snowandthunder_svg__c"
          width={100}
          height={100}
          fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#snowandthunder_svg__d"
        width={100}
        height={100}
    ...
    <use xlinkHref="#snowandthunder_svg__e" width={100} height={100} />
  </svg>
);
export default SvgSnowandthunder;
