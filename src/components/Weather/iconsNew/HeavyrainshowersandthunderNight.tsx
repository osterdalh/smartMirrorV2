...
const SvgHeavyrainshowersandthunderNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="heavyrainshowersandthunder_night_svg__h">
      <g mask="url(#heavyrainshowersandthunder_night_svg__a)">
        <use
          xlinkHref="#heavyrainshowersandthunder_night_svg__b"
          width={100}
          height={100}
          fill="#999"
      ...
      <use
        xlinkHref="#heavyrainshowersandthunder_night_svg__c"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#heavyrainshowersandthunder_night_svg__d"
        width={100}
        height={100}
    ...
    <symbol id="heavyrainshowersandthunder_night_svg__g">
      <path
        fill="url(#heavyrainshowersandthunder_night_svg__e)"
    ...
    <defs>
      <mask id="heavyrainshowersandthunder_night_svg__f">
      ...
      <mask id="heavyrainshowersandthunder_night_svg__a">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#heavyrainshowersandthunder_night_svg__c"
          width={100}
      ...
      <linearGradient
        id="heavyrainshowersandthunder_night_svg__e"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
    ...
    <symbol id="heavyrainshowersandthunder_night_svg__i">
      <g mask="url(#heavyrainshowersandthunder_night_svg__f)">
        <use
          xlinkHref="#heavyrainshowersandthunder_night_svg__g"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavyrainshowersandthunder_night_svg__h"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#heavyrainshowersandthunder_night_svg__i"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgHeavyrainshowersandthunderNight;
