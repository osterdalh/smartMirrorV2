...
const SvgFairPolartwilight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="fair_polartwilight_svg__d">
      <path
        fill="url(#fair_polartwilight_svg__a)"
        ...
        className="fair_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="fair_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#fair_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="fair_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="fair_polartwilight_svg__e">
    ...
    <symbol id="fair_polartwilight_svg__g">
      <g mask="url(#fair_polartwilight_svg__c)">
        <use
          xlinkHref="#fair_polartwilight_svg__d"
          width={100}
          height={100}
          className="fair_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="fair_polartwilight_svg__f">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#fair_polartwilight_svg__e"
          width={100}
          height={100}
          stroke="#000"
      ...
      <mask id="fair_polartwilight_svg__c">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <radialGradient
        id="fair_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
    ...
    <symbol id="fair_polartwilight_svg__h">
      <g mask="url(#fair_polartwilight_svg__f)">
        <use
          xlinkHref="#fair_polartwilight_svg__g"
          width={100}
          height={100}
    ...
    <use xlinkHref="#fair_polartwilight_svg__h" width={100} height={100} />
  </svg>
);
export default SvgFairPolartwilight;
