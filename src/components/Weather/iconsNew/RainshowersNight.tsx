...
const SvgRainshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="rainshowers_night_svg__f">
      <use
        xlinkHref="#rainshowers_night_svg__a"
        width={100}
        height={100}
        fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#rainshowers_night_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="rainshowers_night_svg__e">
      <path
        fill="url(#rainshowers_night_svg__c)"
    ...
    <defs>
      ...
      <mask id="rainshowers_night_svg__d">
    ...
    <symbol id="rainshowers_night_svg__g">
      <g mask="url(#rainshowers_night_svg__d)">
        <use
          xlinkHref="#rainshowers_night_svg__e"
          width={100}
          height={100}
          transform="matrix(.71429 0 0 .71429 2 5)"
        />
      </g>
      <use xlinkHref="#rainshowers_night_svg__f" width={100} height={100} />
    </symbol>
    <use xlinkHref="#rainshowers_night_svg__g" width={100} height={100} />
  </svg>
);
export default SvgRainshowersNight;
