...
const SvgRainshowersDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="rainshowers_day_svg__g">
      <use
        xlinkHref="#rainshowers_day_svg__a"
        width={100}
        height={100}
        fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#rainshowers_day_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="rainshowers_day_svg__f">
      <path
        fill="url(#rainshowers_day_svg__c)"
        ...
        className="rainshowers_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="rainshowers_day_svg__sun-outer"
      />
      <path
        fill="url(#rainshowers_day_svg__d)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="rainshowers_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
        id="rainshowers_day_svg__c"
        cx={41}
        cy={41}
        r={41}
      ...
      <mask id="rainshowers_day_svg__e">
    ...
    <symbol id="rainshowers_day_svg__h">
      <g mask="url(#rainshowers_day_svg__e)">
        <use
          xlinkHref="#rainshowers_day_svg__f"
          width={100}
          height={100}
          transform="matrix(.7 0 0 .7 0 2)"
        />
      </g>
      <use xlinkHref="#rainshowers_day_svg__g" width={100} height={100} />
    </symbol>
    <use xlinkHref="#rainshowers_day_svg__h" width={100} height={100} />
  </svg>
);
export default SvgRainshowersDay;
