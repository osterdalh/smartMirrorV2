...
const SvgLightrainshowersandthunderNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightrainshowersandthunder_night_svg__h">
      <g mask="url(#lightrainshowersandthunder_night_svg__a)">
        <use
          xlinkHref="#lightrainshowersandthunder_night_svg__b"
          width={100}
          height={100}
          fill="#ccc"
      ...
      <use
        xlinkHref="#lightrainshowersandthunder_night_svg__c"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#lightrainshowersandthunder_night_svg__d"
        width={100}
        height={100}
    ...
    <symbol id="lightrainshowersandthunder_night_svg__g">
      <path
        fill="url(#lightrainshowersandthunder_night_svg__e)"
    ...
    <defs>
      <mask id="lightrainshowersandthunder_night_svg__f">
      ...
      <mask id="lightrainshowersandthunder_night_svg__a">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#lightrainshowersandthunder_night_svg__c"
          width={100}
      ...
      <linearGradient
        id="lightrainshowersandthunder_night_svg__e"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
    ...
    <symbol id="lightrainshowersandthunder_night_svg__i">
      <g mask="url(#lightrainshowersandthunder_night_svg__f)">
        <use
          xlinkHref="#lightrainshowersandthunder_night_svg__g"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#lightrainshowersandthunder_night_svg__h"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#lightrainshowersandthunder_night_svg__i"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgLightrainshowersandthunderNight;
