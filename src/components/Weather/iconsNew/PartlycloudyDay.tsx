...
const SvgPartlycloudyDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="partlycloudy_day_svg__a">
    ...
    <symbol id="partlycloudy_day_svg__f">
      <use
        xlinkHref="#partlycloudy_day_svg__a"
        width={100}
        height={100}
        fill="#ddd"
    ...
    <symbol id="partlycloudy_day_svg__e">
      <path
        ...
        className="partlycloudy_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="partlycloudy_day_svg__sun-outer"
      />
      <path
        fill="url(#partlycloudy_day_svg__c)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="partlycloudy_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
      ...
      <mask id="partlycloudy_day_svg__d">
    ...
    <symbol id="partlycloudy_day_svg__g">
      <g mask="url(#partlycloudy_day_svg__d)">
        <use
          xlinkHref="#partlycloudy_day_svg__e"
          width={100}
          height={100}
          transform="matrix(.7 0 0 .7 0 2)"
        />
      </g>
      <use xlinkHref="#partlycloudy_day_svg__f" width={100} height={100} />
    </symbol>
    <use xlinkHref="#partlycloudy_day_svg__g" width={100} height={100} />
  </svg>
);
