...
const SvgHeavysnowshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="heavysnowshowers_night_svg__b">
      <path
        fill="#47c0e3"
    ...
    <symbol id="heavysnowshowers_night_svg__a">
    ...
    <symbol id="heavysnowshowers_night_svg__f">
      <use
        xlinkHref="#heavysnowshowers_night_svg__a"
        width={100}
        height={100}
        fill="#999"
      ...
      />
      <use
        xlinkHref="#heavysnowshowers_night_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="heavysnowshowers_night_svg__e">
      <path
        fill="url(#heavysnowshowers_night_svg__c)"
    ...
    <defs>
      <linearGradient
        id="heavysnowshowers_night_svg__c"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
      ...
      <mask id="heavysnowshowers_night_svg__d">
    ...
    <symbol id="heavysnowshowers_night_svg__g">
      <g mask="url(#heavysnowshowers_night_svg__d)">
        <use
          xlinkHref="#heavysnowshowers_night_svg__e"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavysnowshowers_night_svg__f"
        width={100}
        height={100}
      />
    </symbol>
    <use xlinkHref="#heavysnowshowers_night_svg__g" width={100} height={100} />
  </svg>
);
export default SvgHeavysnowshowersNight;
