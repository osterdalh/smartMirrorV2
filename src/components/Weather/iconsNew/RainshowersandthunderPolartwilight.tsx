...
const SvgRainshowersandthunderPolartwilight = (
  ...
  >
    ...
    <symbol id="rainshowersandthunder_polartwilight_svg__h">
      <path
        fill="url(#rainshowersandthunder_polartwilight_svg__a)"
        ...
        className="rainshowersandthunder_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="rainshowersandthunder_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#rainshowersandthunder_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="rainshowersandthunder_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="rainshowersandthunder_polartwilight_svg__k">
      <g mask="url(#rainshowersandthunder_polartwilight_svg__c)">
        <use
          xlinkHref="#rainshowersandthunder_polartwilight_svg__d"
          width={100}
          height={100}
          fill="#b2b2b2"
      ...
      <use
        xlinkHref="#rainshowersandthunder_polartwilight_svg__e"
        width={100}
        height={100}
        transform="translate(37 51)"
      />
      <use
        xlinkHref="#rainshowersandthunder_polartwilight_svg__f"
        width={100}
        height={100}
    ...
    <symbol id="rainshowersandthunder_polartwilight_svg__j">
      <g mask="url(#rainshowersandthunder_polartwilight_svg__g)">
        <use
          xlinkHref="#rainshowersandthunder_polartwilight_svg__h"
          width={100}
          height={100}
          className="rainshowersandthunder_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="rainshowersandthunder_polartwilight_svg__i">
      ...
      <mask id="rainshowersandthunder_polartwilight_svg__g">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <mask id="rainshowersandthunder_polartwilight_svg__c">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#rainshowersandthunder_polartwilight_svg__e"
          width={100}
      ...
      <radialGradient
        id="rainshowersandthunder_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="rainshowersandthunder_polartwilight_svg__b"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="rainshowersandthunder_polartwilight_svg__l">
      <g mask="url(#rainshowersandthunder_polartwilight_svg__i)">
        <use
          xlinkHref="#rainshowersandthunder_polartwilight_svg__j"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#rainshowersandthunder_polartwilight_svg__k"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#rainshowersandthunder_polartwilight_svg__l"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgRainshowersandthunderPolartwilight;
