...
const SvgSleetshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="sleetshowers_night_svg__a">
    ...
    <symbol id="sleetshowers_night_svg__g">
      <use
        xlinkHref="#sleetshowers_night_svg__a"
        width={100}
        height={100}
        fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#sleetshowers_night_svg__b"
        width={100}
        height={100}
        transform="translate(30 79)"
      />
      <use
        xlinkHref="#sleetshowers_night_svg__c"
        width={100}
        height={100}
    ...
    <symbol id="sleetshowers_night_svg__f">
      <path
        fill="url(#sleetshowers_night_svg__d)"
    ...
    <defs>
      ...
      <mask id="sleetshowers_night_svg__e">
    ...
    <symbol id="sleetshowers_night_svg__h">
      <g mask="url(#sleetshowers_night_svg__e)">
        <use
          xlinkHref="#sleetshowers_night_svg__f"
          width={100}
          height={100}
          transform="matrix(.71429 0 0 .71429 2 5)"
        />
      </g>
      <use xlinkHref="#sleetshowers_night_svg__g" width={100} height={100} />
    </symbol>
    <use xlinkHref="#sleetshowers_night_svg__h" width={100} height={100} />
  </svg>
);
export default SvgSleetshowersNight;
