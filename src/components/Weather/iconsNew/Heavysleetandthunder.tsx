...
const SvgHeavysleetandthunder = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="heavysleetandthunder_svg__a">
      <path
        fill="#ffdd15"
        d="m19.6 23.42-6.86-3.03L15.55 5 5 24.49l7.08 3.02L7.49 45 19.6 23.42z"
      />
    </symbol>
    <symbol id="heavysleetandthunder_svg__c">
    ...
    <defs>
      <mask id="heavysleetandthunder_svg__b">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#heavysleetandthunder_svg__a"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="heavysleetandthunder_svg__f">
      <g mask="url(#heavysleetandthunder_svg__b)">
        <use
          xlinkHref="#heavysleetandthunder_svg__c"
          width={100}
          height={100}
          fill="#999"
      ...
      />
      <use
        xlinkHref="#heavysleetandthunder_svg__d"
        width={100}
        height={100}
        transform="translate(15 79)"
      />
      <use
        xlinkHref="#heavysleetandthunder_svg__e"
        width={100}
        height={100}
    ...
    <use xlinkHref="#heavysleetandthunder_svg__f" width={100} height={100} />
  </svg>
);
export default SvgHeavysleetandthunder;
