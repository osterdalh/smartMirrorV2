...
const SvgSnowshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="snowshowers_night_svg__b">
      <path
        fill="#47c0e3"
    ...
    <symbol id="snowshowers_night_svg__a">
    ...
    <symbol id="snowshowers_night_svg__f">
      <use
        xlinkHref="#snowshowers_night_svg__a"
        width={100}
        height={100}
        fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#snowshowers_night_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="snowshowers_night_svg__e">
      <path
        fill="url(#snowshowers_night_svg__c)"
    ...
    <defs>
      ...
      <mask id="snowshowers_night_svg__d">
    ...
    <symbol id="snowshowers_night_svg__g">
      <g mask="url(#snowshowers_night_svg__d)">
        <use
          xlinkHref="#snowshowers_night_svg__e"
          width={100}
          height={100}
          transform="matrix(.71429 0 0 .71429 2 5)"
        />
      </g>
      <use xlinkHref="#snowshowers_night_svg__f" width={100} height={100} />
    </symbol>
    <use xlinkHref="#snowshowers_night_svg__g" width={100} height={100} />
  </svg>
);
export default SvgSnowshowersNight;
