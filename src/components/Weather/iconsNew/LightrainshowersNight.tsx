...
const SvgLightrainshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightrainshowers_night_svg__f">
      <use
        xlinkHref="#lightrainshowers_night_svg__a"
        width={100}
        height={100}
        fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightrainshowers_night_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="lightrainshowers_night_svg__e">
      <path
        fill="url(#lightrainshowers_night_svg__c)"
    ...
    <defs>
      <linearGradient
        id="lightrainshowers_night_svg__c"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
      ...
      <mask id="lightrainshowers_night_svg__d">
    ...
    <symbol id="lightrainshowers_night_svg__g">
      <g mask="url(#lightrainshowers_night_svg__d)">
        <use
          xlinkHref="#lightrainshowers_night_svg__e"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#lightrainshowers_night_svg__f"
        width={100}
        height={100}
      />
    </symbol>
    <use xlinkHref="#lightrainshowers_night_svg__g" width={100} height={100} />
  </svg>
);
export default SvgLightrainshowersNight;
