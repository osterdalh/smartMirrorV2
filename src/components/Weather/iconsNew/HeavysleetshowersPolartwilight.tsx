...
const SvgHeavysleetshowersPolartwilight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="heavysleetshowers_polartwilight_svg__e">
      <path
        fill="#0062bf"
        d="M2.5 13A2.5 2.5 0 0 1 .21 9.51l3.55-8a2.5 2.5 0 0 1 4.57 2l-3.55 8A2.5 2.5 0 0 1 2.5 13Z"
      />
    </symbol>
    <symbol id="heavysleetshowers_polartwilight_svg__d">
      <path
        fill="#47c0e3"
    ...
    <symbol id="heavysleetshowers_polartwilight_svg__c">
    ...
    <symbol id="heavysleetshowers_polartwilight_svg__g">
      <path
        fill="url(#heavysleetshowers_polartwilight_svg__a)"
        ...
        className="heavysleetshowers_polartwilight_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="heavysleetshowers_polartwilight_svg__sun-outer"
      />
      <path
        fill="url(#heavysleetshowers_polartwilight_svg__b)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="heavysleetshowers_polartwilight_svg__sun-inner"
      />
    </symbol>
    <symbol id="heavysleetshowers_polartwilight_svg__j">
      <use
        xlinkHref="#heavysleetshowers_polartwilight_svg__c"
        width={100}
        height={100}
        fill="#999"
      ...
      />
      <use
        xlinkHref="#heavysleetshowers_polartwilight_svg__d"
        width={100}
        height={100}
        transform="translate(15 79)"
      />
      <use
        xlinkHref="#heavysleetshowers_polartwilight_svg__e"
        width={100}
        height={100}
    ...
    <symbol id="heavysleetshowers_polartwilight_svg__i">
      <g mask="url(#heavysleetshowers_polartwilight_svg__f)">
        <use
          xlinkHref="#heavysleetshowers_polartwilight_svg__g"
          width={100}
          height={100}
          className="heavysleetshowers_polartwilight_svg__sun-primitive"
    ...
    <defs>
      <mask id="heavysleetshowers_polartwilight_svg__h">
      ...
      <mask id="heavysleetshowers_polartwilight_svg__f">
        <path fill="#fff" d="M0 0h100v100H0z" />
      </mask>
      <radialGradient
        id="heavysleetshowers_polartwilight_svg__a"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="heavysleetshowers_polartwilight_svg__b"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
    ...
    <symbol id="heavysleetshowers_polartwilight_svg__k">
      <g mask="url(#heavysleetshowers_polartwilight_svg__h)">
        <use
          xlinkHref="#heavysleetshowers_polartwilight_svg__i"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavysleetshowers_polartwilight_svg__j"
        width={100}
        height={100}
      />
    </symbol>
    <use
      xlinkHref="#heavysleetshowers_polartwilight_svg__k"
      width={100}
      height={100}
    />
  </svg>
);
export default SvgHeavysleetshowersPolartwilight;
