...
const SvgLightsnow = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightsnow_svg__c">
      <use
        xlinkHref="#lightsnow_svg__a"
        width={100}
        height={100}
        fill="#ccc"
    ...
    <use xlinkHref="#lightsnow_svg__c" width={100} height={100} />
  </svg>
);
export default SvgLightsnow;
