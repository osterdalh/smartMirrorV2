...
const SvgLightsnowshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <symbol id="lightsnowshowers_night_svg__b">
      <path
        fill="#47c0e3"
    ...
    <symbol id="lightsnowshowers_night_svg__a">
    ...
    <symbol id="lightsnowshowers_night_svg__f">
      <use
        xlinkHref="#lightsnowshowers_night_svg__a"
        width={100}
        height={100}
        fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightsnowshowers_night_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="lightsnowshowers_night_svg__e">
      <path
        fill="url(#lightsnowshowers_night_svg__c)"
    ...
    <defs>
      <linearGradient
        id="lightsnowshowers_night_svg__c"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
      ...
      <mask id="lightsnowshowers_night_svg__d">
    ...
    <symbol id="lightsnowshowers_night_svg__g">
      <g mask="url(#lightsnowshowers_night_svg__d)">
        <use
          xlinkHref="#lightsnowshowers_night_svg__e"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#lightsnowshowers_night_svg__f"
        width={100}
        height={100}
      />
    </symbol>
    <use xlinkHref="#lightsnowshowers_night_svg__g" width={100} height={100} />
  </svg>
);
export default SvgLightsnowshowersNight;
