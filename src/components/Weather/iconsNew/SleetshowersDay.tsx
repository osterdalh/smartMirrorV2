...
const SvgSleetshowersDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="sleetshowers_day_svg__a">
    ...
    <symbol id="sleetshowers_day_svg__h">
      <use
        xlinkHref="#sleetshowers_day_svg__a"
        width={100}
        height={100}
        fill="#b2b2b2"
      ...
      />
      <use
        xlinkHref="#sleetshowers_day_svg__b"
        width={100}
        height={100}
        transform="translate(30 79)"
      />
      <use
        xlinkHref="#sleetshowers_day_svg__c"
        width={100}
        height={100}
    ...
    <symbol id="sleetshowers_day_svg__g">
      <path
        fill="url(#sleetshowers_day_svg__d)"
        ...
        className="sleetshowers_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="sleetshowers_day_svg__sun-outer"
      />
      <path
        fill="url(#sleetshowers_day_svg__e)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="sleetshowers_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
        id="sleetshowers_day_svg__d"
        cx={41}
        cy={41}
        r={41}
      ...
      <mask id="sleetshowers_day_svg__f">
    ...
    <symbol id="sleetshowers_day_svg__i">
      <g mask="url(#sleetshowers_day_svg__f)">
        <use
          xlinkHref="#sleetshowers_day_svg__g"
          width={100}
          height={100}
          transform="matrix(.7 0 0 .7 0 2)"
        />
      </g>
      <use xlinkHref="#sleetshowers_day_svg__h" width={100} height={100} />
    </symbol>
    <use xlinkHref="#sleetshowers_day_svg__i" width={100} height={100} />
  </svg>
);
export default SvgSleetshowersDay;
