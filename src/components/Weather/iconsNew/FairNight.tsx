...
const SvgFairNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="fair_night_svg__d">
      <path
        fill="url(#fair_night_svg__a)"
    ...
    <defs>
      <linearGradient id="fair_night_svg__a" x1="0%" x2="100%" y1="50%" y2="0%">
        <stop offset="0%" stopColor="#686e73" />
        <stop offset="100%" stopColor="#6a7075" />
      </linearGradient>
      <mask id="fair_night_svg__c">
        <path fill="#fff" d="M0 0h100v100H0z" />
        <use
          xlinkHref="#fair_night_svg__b"
          width={100}
          height={100}
          stroke="#000"
    ...
    <symbol id="fair_night_svg__e">
      <g mask="url(#fair_night_svg__c)">
        <use
          xlinkHref="#fair_night_svg__d"
          width={100}
          height={100}
    ...
    <use xlinkHref="#fair_night_svg__e" width={100} height={100} />
  </svg>
);
export default SvgFairNight;
