...
const SvgLightsleetshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightsleetshowers_night_svg__a">
    ...
    <symbol id="lightsleetshowers_night_svg__g">
      <use
        xlinkHref="#lightsleetshowers_night_svg__a"
        width={100}
        height={100}
        fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightsleetshowers_night_svg__b"
        width={100}
        height={100}
        transform="translate(29 88)"
      />
      <use
        xlinkHref="#lightsleetshowers_night_svg__c"
        width={100}
        height={100}
        transform="translate(60 79)"
      />
    </symbol>
    <symbol id="lightsleetshowers_night_svg__f">
      <path
        fill="url(#lightsleetshowers_night_svg__d)"
    ...
    <defs>
      <linearGradient
        id="lightsleetshowers_night_svg__d"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
      ...
      <mask id="lightsleetshowers_night_svg__e">
    ...
    <symbol id="lightsleetshowers_night_svg__h">
      <g mask="url(#lightsleetshowers_night_svg__e)">
        <use
          xlinkHref="#lightsleetshowers_night_svg__f"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#lightsleetshowers_night_svg__g"
        width={100}
        height={100}
      />
    </symbol>
    <use xlinkHref="#lightsleetshowers_night_svg__h" width={100} height={100} />
  </svg>
);
export default SvgLightsleetshowersNight;
