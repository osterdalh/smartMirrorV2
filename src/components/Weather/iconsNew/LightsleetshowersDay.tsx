...
const SvgLightsleetshowersDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="lightsleetshowers_day_svg__a">
    ...
    <symbol id="lightsleetshowers_day_svg__h">
      <use
        xlinkHref="#lightsleetshowers_day_svg__a"
        width={100}
        height={100}
        fill="#ccc"
      ...
      />
      <use
        xlinkHref="#lightsleetshowers_day_svg__b"
        width={100}
        height={100}
        transform="translate(29 88)"
      />
      <use
        xlinkHref="#lightsleetshowers_day_svg__c"
        width={100}
        height={100}
        transform="translate(60 79)"
      />
    </symbol>
    <symbol id="lightsleetshowers_day_svg__g">
      <path
        fill="url(#lightsleetshowers_day_svg__d)"
        ...
        className="lightsleetshowers_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="lightsleetshowers_day_svg__sun-outer"
      />
      <path
        fill="url(#lightsleetshowers_day_svg__e)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="lightsleetshowers_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
        id="lightsleetshowers_day_svg__d"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="lightsleetshowers_day_svg__e"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
      ...
      <mask id="lightsleetshowers_day_svg__f">
    ...
    <symbol id="lightsleetshowers_day_svg__i">
      <g mask="url(#lightsleetshowers_day_svg__f)">
        <use
          xlinkHref="#lightsleetshowers_day_svg__g"
          width={100}
          height={100}
          transform="matrix(.7 0 0 .7 0 2)"
        />
      </g>
      <use xlinkHref="#lightsleetshowers_day_svg__h" width={100} height={100} />
    </symbol>
    <use xlinkHref="#lightsleetshowers_day_svg__i" width={100} height={100} />
  </svg>
);
export default SvgLightsleetshowersDay;
