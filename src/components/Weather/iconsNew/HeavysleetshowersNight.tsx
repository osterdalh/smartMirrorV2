...
const SvgHeavysleetshowersNight = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="heavysleetshowers_night_svg__a">
    ...
    <symbol id="heavysleetshowers_night_svg__g">
      <use
        xlinkHref="#heavysleetshowers_night_svg__a"
        width={100}
        height={100}
        fill="#999"
      ...
      />
      <use
        xlinkHref="#heavysleetshowers_night_svg__b"
        width={100}
        height={100}
        transform="translate(15 79)"
      />
      <use
        xlinkHref="#heavysleetshowers_night_svg__c"
        width={100}
        height={100}
    ...
    <symbol id="heavysleetshowers_night_svg__f">
      <path
        fill="url(#heavysleetshowers_night_svg__d)"
    ...
    <defs>
      <linearGradient
        id="heavysleetshowers_night_svg__d"
        x1="0%"
        x2="100%"
        y1="50%"
        y2="0%"
      ...
      <mask id="heavysleetshowers_night_svg__e">
    ...
    <symbol id="heavysleetshowers_night_svg__h">
      <g mask="url(#heavysleetshowers_night_svg__e)">
        <use
          xlinkHref="#heavysleetshowers_night_svg__f"
          width={100}
          height={100}
      ...
      <use
        xlinkHref="#heavysleetshowers_night_svg__g"
        width={100}
        height={100}
      />
    </symbol>
    <use xlinkHref="#heavysleetshowers_night_svg__h" width={100} height={100} />
  </svg>
);
export default SvgHeavysleetshowersNight;
