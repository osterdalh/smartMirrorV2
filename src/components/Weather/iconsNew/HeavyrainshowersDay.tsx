...
const SvgHeavyrainshowersDay = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <symbol id="heavyrainshowers_day_svg__g">
      <use
        xlinkHref="#heavyrainshowers_day_svg__a"
        width={100}
        height={100}
        fill="#999"
      ...
      />
      <use
        xlinkHref="#heavyrainshowers_day_svg__b"
        width={100}
        height={100}
    ...
    <symbol id="heavyrainshowers_day_svg__f">
      <path
        fill="url(#heavyrainshowers_day_svg__c)"
        ...
        className="heavyrainshowers_day_svg__sun-glow"
      />
      <path
        fill="#ffd348"
        d="M19.28 53.5a25 25 0 1 0 9.15-34.16 25 25 0 0 0-9.15 34.16Z"
        className="heavyrainshowers_day_svg__sun-outer"
      />
      <path
        fill="url(#heavyrainshowers_day_svg__d)"
        d="M22.74 51.5a21 21 0 1 0 7.69-28.69 21 21 0 0 0-7.69 28.69Z"
        className="heavyrainshowers_day_svg__sun-inner"
      />
    </symbol>
    <defs>
      <radialGradient
        id="heavyrainshowers_day_svg__c"
        cx={41}
        cy={41}
        r={41}
      ...
      <linearGradient
        id="heavyrainshowers_day_svg__d"
        x1="0%"
        x2="100%"
        y1="0%"
        y2="100%"
      ...
      <mask id="heavyrainshowers_day_svg__e">
    ...
    <symbol id="heavyrainshowers_day_svg__h">
      <g mask="url(#heavyrainshowers_day_svg__e)">
        <use
          xlinkHref="#heavyrainshowers_day_svg__f"
          width={100}
          height={100}
          transform="matrix(.7 0 0 .7 0 2)"
        />
      </g>
      <use xlinkHref="#heavyrainshowers_day_svg__g" width={100} height={100} />
    </symbol>
    <use xlinkHref="#heavyrainshowers_day_svg__h" width={100} height={100} />
  </svg>
);
export default SvgHeavyrainshowersDay;
